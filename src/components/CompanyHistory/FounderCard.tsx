...
const FounderCard: React.FC = () => {
  ...
  return (
    <div 
      ref={containerRef} 
      className="min-h-screen flex items-center justify-center overflow-hidden relative py-16 md:py-32 sticky top-0"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto">
          ...
          <motion.div 
            className="w-full md:w-1/2 mb-8 md:mb-0 relative px-4 sm:px-8 md:px-0"
          ...
          >
            ...
            >
              <div className="pb-[110%] md:pb-[120%] relative overflow-hidden">
                <img 
          ...
          >
            ...
            >
              <div className="inline-block px-4 py-1 rounded-full bg-white/10 text-white/80 text-sm font-medium mb-4 md:mb-6">
                Nosso Fundador
              </div>
            </motion.div>
            ...
            <div className="flex justify-center md:justify-start">
              <motion.div 
                className="flex items-center mb-6 md:mb-8 overflow-hidden"
                initial={{ opacity: 0, width: 0 }}
                animate={isInView ? { opacity: 1, width: "100%" } : { opacity: 0, width: 0 }}
                transition={{ duration: 0.8, delay: 0.3 }}
              >
                <div className="h-px bg-[#db0500] w-8 md:w-12 mr-3 md:mr-4 flex-shrink-0"></div>
                <span className="text-lg md:text-xl font-semibold text-white/80 whitespace-nowrap flex-shrink-0">Visionário & Empreendedor</span>
              </motion.div>
            </div>
            
            <motion.p 
              className="text-base md:text-lg text-white/70 mb-6 md:mb-8 leading-relaxed px-2 md:px-0"
      ...
      <div className="absolute bottom-4 md:bottom-8 left-0 w-full overflow-hidden h-8 md:h-12 opacity-20 md:opacity-30 z-0">
        <motion.div 
          className="flex"
          initial={{ x: "100%" }}
        ...
        >
          {[1994, 1995, 1998, 2002, 2007, 2012, 2015, 2020, 2025].map((year, i) => (
            <div key={i} className="text-6xl md:text-9xl font-bold text-white/10 whitespace-nowrap mx-6 md:mx-12">
              {year}
            </div>
          ))}
        </motion.div>
